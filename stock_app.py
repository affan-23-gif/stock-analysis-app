...
# redirect urls
github_redirect_url = "https://github.com/affan-23-gif"
...
""", unsafe_allow_html=True)
st.markdown(f'<div class="footer">Made with ❤️ by Affan Ansari<a href="{github_redirect_url}"><img src="{github_url}" width="30" height="30"></a>', unsafe_allow_html=True)